...
import { ArenaLeaderboard, Artifact, ArtifactId, EthAddress, Leaderboard, LocationId, Planet, Player, Transaction, TransactionId } from '@darkforest_eth/types';
...
export declare function useSelectedPlanetId(uiManager: GameUIManager, defaultId?: LocationId): Wrapper<LocationId>;
...
export declare function useArtifact(uiManager: GameUIManager, artifactId: ArtifactId): Wrapper<Artifact>;
/** Loads the leaderboard */
export declare function useLeaderboard(poll?: number | undefined): {
    leaderboard: Leaderboard | undefined;
    error: Error | undefined;
};
export declare function useArenaLeaderboard(poll?: number | undefined): {
    leaderboard: ArenaLeaderboard | undefined;
    error: Error | undefined;
};
export declare function useCompetitiveLeaderboard(isCompetitive: boolean, address?: string | undefined, poll?: number | undefined): {
...
export declare function useGameover(): boolean;
