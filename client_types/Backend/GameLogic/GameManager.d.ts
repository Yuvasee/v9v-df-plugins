...
import { Artifact, ArtifactId, CaptureZone, Chunk, ClaimedLocation, Diagnostics, EthAddress, LocatablePlanet, LocationId, NetworkHealthSummary, Planet, PlanetLevel, Player, QueuedArrival, Radii, Rectangle, RevealedLocation, SpaceType, Transaction, TxIntent, UnconfirmedActivateArtifact, UnconfirmedBuyHat, UnconfirmedCapturePlanet, UnconfirmedClaimVictory, UnconfirmedDeactivateArtifact, UnconfirmedDepositArtifact, UnconfirmedFindArtifact, UnconfirmedInvadePlanet, UnconfirmedMove, UnconfirmedPlanetTransfer, UnconfirmedProspectPlanet, UnconfirmedReveal, UnconfirmedUpgrade, UnconfirmedWithdrawArtifact, UnconfirmedWithdrawSilver, Upgrade, WorldCoords, WorldLocation, Wormhole } from '@darkforest_eth/types';
...
declare class GameManager extends EventEmitter {
   ...
   */
    ...
    destroy(): void;
    static create({ connection, terminal, contractAddress, spectator, configHash, }: {
