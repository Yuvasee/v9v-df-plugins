...
export declare const blocksLeftToProspectExpiration: (currentBlockNumber: number, prospectedBlockNumber?: number) => number;
export declare const prospectExpired: (currentBlockNumber: number, prospectedBlockNumber: number) => boolean;
export declare const isFindable: (planet: Planet, currentBlockNumber?: number) => boolean;
