...
import { Artifact, ArtifactId, Chunk, ClaimedLocation, EthAddress, LocatablePlanet, LocationId, Planet, PlanetLevel, PlanetType, QueuedArrival, Radii, RevealedLocation, SpaceType, Transaction, TransactionCollection, VoyageId, WorldCoords, WorldLocation, Wormhole } from '@darkforest_eth/types';
...
export declare class GameObjects {
     ...
     */
    private readonly planetArrivalIds;
    /**
     ...
     */
    private readonly planetLocationMap;
    /**
     ...
     */
    private readonly coordsToLocation;
    /**
     ...
     */
    private emitArrivalNotifications;
    private removeArrival;
    private processArrivalsForPlanet;
    private clearOldArrivals;
     ...
     */
    private defaultPlanetFromLocation;
    private updatePlanetIfStale;
    /**
