import { ArtifactRarity, ArtifactType, EthAddress, LocatablePlanet, Planet, Upgrade, UpgradeBranchName } from '@darkforest_eth/types';
...
export declare const isRoundOngoing: () => boolean;
export declare function getDeterministicArtifact(planet: LocatablePlanet): {
    type: ArtifactType;
